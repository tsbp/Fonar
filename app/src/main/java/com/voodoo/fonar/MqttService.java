...
public class MqttService extends Service implements MqttCallback
{
    ...
    private static final String MQTT_BROKER = "mqtt.flespi.io"; // Broker URL or IP Address
    private static final int MQTT_PORT = 1883; // Broker Port
    private static final String MQTT_USER = "FlespiToken bfUzvs98I9kmxiwMufAnn1E9jTd5DN3EQN19418C0gOlm9XHclUpanpj6qdx36ZI";
    private static final String MQTT_USER_PASSWORD = "123454321";
    ...
    private static final String MQTT_SUBSCRIBE_TOPIC = "stt";
    ...
    private static final String MQTT_URL_FORMAT = "tcp://%s:%d"; // URL Format normally don't change wss://mqtt.flespi.io
    ...
    private void mqtt_create_options()
    {
            ...
            mConnHandler.post(new Runnable() {
                            ...
                            public void run() {
                                    try {
                                            ...
                                            mClient.subscribe(MQTT_SUBSCRIBE_TOPIC, 0);
